...
const DISTRIBUTORS = [
  ...
  },
  {
    ...
    type: 'managed-distributor',
    enabled: true,
    notes: 'Rodent/pest exclusion door sweeps and seals. Priced from the vendor price list (price-lists/raw).',
    categories: [],
  },
  {
    id: 'motion-access',
    name: 'Motion Access, LLC',
    website: 'https://www.motionaccess.com/',
    type: 'managed-distributor',
    enabled: true,
    notes: 'Condor slide/swing operators, controls and OEM replacement motors. Priced from the vendor price list (price-lists/raw).',
    categories: [],
  },
  {
    id: 'ms-sedco',
    name: 'MS Sedco',
    website: 'https://www.mssedco.com/',
    type: 'managed-distributor',
    enabled: true,
    notes: 'Push plates, touchless switches and sensors. Priced from the vendor price list (price-lists/raw).',
    categories: [],
  },
  {
    id: 'ready-access',
    name: 'Ready Access',
    website: 'https://www.ready-access.com/',
    type: 'managed-manufacturer',
    enabled: true,
    notes: 'Drive-thru windows and parts. Priced from the vendor price list (price-lists/raw).',
    categories: [],
  },
  {
    id: 'quad-systems',
    name: 'Quad Systems LLC',
    website: 'https://www.quadsystemsllc.com/',
    type: 'managed-distributor',
    enabled: true,
    notes: 'DCM DC4000/DC7000 operators and Horton parts. Pricing so far comes from a sales quote, not a full price list.',
    categories: [],
  },
  {
    id: 'roto-frank',
